  ...
  $("#js-part-id").on("click", function(){
    ...
    switch (id) {
      case "1":
        ...
        data += '<input id="imgInp" type="file" name="picture" required accept="image/gif, image/jpeg, image/png">';
        data += '</div>';
        data += '<div class="form-group">';
        data += '<label for="voice">Voice *</label>';
        data += '<input type="file" name="voice" required accept=".mp3,audio/*">';
        data += '</div>';
        data += '<div class="form-group">';
        data += '<label for="content">Content *</label>';
        data += '<input type="text" name="content" class="form-control" required value="Mark your answer on your answersheet.">';
        data += '<label for="answer">Answers *</label>';
        data += '<input type="text" name="answer1" class="form-control" required value="(A) ">';
        data += '<input type="text" name="answer2" class="form-control" required value="(B) ">';
        data += '<input type="text" name="answer3" class="form-control" required value="(C) ">';
        data += '<input type="text" name="answer4" class="form-control" required value="(D) ">';
        data += '</div>';
        break;
      case "2":
          data += '<div class="form-group">';
      ...
      case "4":        
          ...
          data += '<input type="text" name="group_qestion" required class="form-control">';
          data += '</div>';
          data += '<div class="form-group">';
          data += '<label for="voice">Voice *</label>';
          data += '<input type="file" name="voice" required accept=".mp3,audio/*">';
          ...
          data += '<input type="text" name="content[]" required class="form-control">';
          data += '<label for="answer">Answers *</label>';
          data += '<input type="text" name="answer1[]" class="form-control" required value="(A) ">';
          data += '<input type="text" name="answer2[]" class="form-control" required value="(B) ">';
          data += '<input type="text" name="answer3[]" class="form-control" required value="(C) ">';
